...
export default async function handler(req, res) {
      ...
      switch (req.method) {
            case "DELETE":
                  ...
                  await dbDelete.collection(collection).deleteOne({ "_id" : ObjectId(req.body.data.id) });
            ...
            case "POST":
                  ...
                  await dbPost.collection(collection).insertOne(req.body.data);
            ...
            case "GET":
                  ...
                  const data = await dbGet.collection(collection).find({}).sort({_id:-1}).toArray();
            ...
            case "PUT":
                  ...
                  const editData = await dbPut.collection(collection).updateOne(query, { $set:toUpdateQuery})
